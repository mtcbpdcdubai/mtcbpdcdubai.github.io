/*
This module exports the function `formatDateRange`, which formats a starting
and ending date-time into a human-readable string.

It accounts for the following edge cases:
👉 when only the time is different, on the same date
👉 when 
*/
...
/** Formats the given start and end date-time into a human-readable string.
